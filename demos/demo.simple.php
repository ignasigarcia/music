...
$DirectoryToScan = '/home/tas/Music/userlikeyou_music/Holden/The_Idiots_Are_Winning/'; // change to whatever directory you want to scan
...
while (($file = readdir($dir)) !== false) {
	...
	if (is_file($FullFileName)) {
		...
		echo '<TD>'.(!empty($ThisFileInfo['comments_html']['title'])  ? implode('<BR>', $ThisFileInfo['comments_html']['album'])  : '&nbsp;').'</TD>';
		echo '<TD>'.(!empty($ThisFileInfo['comments_html']['title'])  ? implode('<BR>', $ThisFileInfo['comments_html']['track_number'])  : '&nbsp;').'</TD>';
